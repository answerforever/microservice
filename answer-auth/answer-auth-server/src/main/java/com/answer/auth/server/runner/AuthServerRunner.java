package com.answer.auth.server.runner;

import com.answer.auth.common.util.jwt.RsaKeyHelper;
import com.answer.auth.server.configuration.KeyConfiguration;
...
public class AuthServerRunner implements CommandLineRunner {
    ...
    private static final String REDIS_USER_PRI_KEY = "AW:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "AW:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "AW:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "AW:AUTH:CLIENT:PUB";
